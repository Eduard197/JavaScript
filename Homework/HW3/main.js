...
let i = 0;
while (i < 20){
    document.write(`<h1>Okten is cool ${i+1}</h1>`);
    i++;
}
...
price: 22,
    ...
    image: 'https://st2.depositphotos.com/1028911/5625/i/950/depositphotos_56257637-stock-photo-3d-milk-carton-box-isolated.jpg'
...

{
    ...
    price: 15,
        ...
        image: 'https://feofanivska.com.ua/wp-content/uploads/2020/07/zelenyj-chaj-lovare-assorti-24-paketika-4-vida-v-pachke.jpg'
